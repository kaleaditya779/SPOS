...
// Inputs => input_pass2.txt, symtable.txt, littable.txt
// Outputs => output_pass2.txt
...
public class Pass2_assembler {
    ...
    private static void readInput() {
        try {
            FileInputStream ip = new FileInputStream("./a2_inp/input_pass2.txt");
            int temp;
    ...
    private static void readLiteral() {
        try {
            FileInputStream ip = new FileInputStream("./a2_inp/littable.txt");
            int temp;
            while ((temp = ip.read()) != -1) {
                inputL += (char) temp;
            }
    ...
    private static void readSymbol() {
        try {
            FileInputStream ip = new FileInputStream("./a2_inp/symtable.txt");
            int temp;
            while ((temp = ip.read()) != -1) {
                inputS += (char) temp;
            }
    ...
    private static void writeOutput(){
        try{
            FileOutputStream op = new FileOutputStream("./a2_out/output_pass2.txt");
