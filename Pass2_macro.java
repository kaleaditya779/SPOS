...
// Inputs => input_pass2M.txt, ala_pass2.txt, mdt_pass2.txt, mnt_pass2.txt.
// No output file..
...
public class Pass2_macro {
    ...
    private static void takeInput() {
        try {
            FileInputStream ip = new FileInputStream("./m2_inp/input_pass2M.txt");
            int temp;
    ...
    private static void takeInputMDT() {
        try {
            FileInputStream ip = new FileInputStream("./m2_inp/mdt_pass2.txt");
            int temp;
    ...
    private static void takeInputALA() {
        try {
            FileInputStream ip = new FileInputStream("./m2_inp/ala_pass2.txt");
            int temp;
    ...
    private static void handleMNT() {
        try {
            String input = "";
            FileInputStream ip = new FileInputStream("./m2_inp/mnt_pass2.txt");
            int temp;
            while ((temp = ip.read()) != -1) {
                input += (char) temp;
            }
