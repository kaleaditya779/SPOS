...
// Inputs => input_pass1M.txt
// Outputs => output_pass1M.txt, ala.txt, mdt.txt, mnt.txt.
...
public class Pass1_macro {
    ...
    private static void readIp() {
        try {
            FileInputStream ip = new FileInputStream("./m1_inp/input_pass1M.txt");
            int temp;
    ...
    public static void outputFiles() {
        try {
            FileOutputStream op = new FileOutputStream("./m1_out/output_pass1M.txt");
            op.write(output.getBytes());
            op.close();

            op = new FileOutputStream("./m1_out/ala.txt");
            op.write(ALA.getBytes());
            op.close();

            op = new FileOutputStream("./m1_out/mdt.txt");
            op.write(MDT.getBytes());
            op.close();

            op = new FileOutputStream("./m1_out/mnt.txt");
