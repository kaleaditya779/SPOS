...
// Inputs => input_pass1.txt
// Outputs => output_pass1.txt
...
public class Pass1_assembler {
	...
	private static void readInput() {
		int ipCharBuff;
		try {
			FileInputStream ip = new FileInputStream("./a1_inp/input_pass1.txt");
	...
	private static void saveOutput() {
		try {
			FileOutputStream out = new FileOutputStream("./a1_out/output_pass1.txt");
